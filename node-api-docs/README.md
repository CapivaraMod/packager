...
We intend to release an updated version of the npm module to npm with every update of [CapivaraMod Desktop](https://github.com/TurboWarp/desktop), which currently happens about once a month.
