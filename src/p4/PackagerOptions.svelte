        ...
        {:else}
          ...
          {#if $options.target.includes('win')}
            <div>
              ...
              <p>To change the icon of the executable file or create an installer program, download and run <a href="https://github.com/TurboWarp/packager-extras/releases">CapivaraMod Packager Extras</a> and select the output of this website.</p>
            </div>
